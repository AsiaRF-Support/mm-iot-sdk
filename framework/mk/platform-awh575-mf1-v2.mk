...
PLATFORM_PATH = src/platforms/awh575-mf1-v2
...
#BSP_SRCS_C += Core/Src/usb_hw_init.c
...
#BSP_SRCS_H += Core/Inc/usb_hw_init.h

# Driver files pulled from common source
BSP_DRIVERS_DIR = src/bsps/stm32cubeu5
#BSP_DRIVERS_DIR = src/platforms/awh575-mf1/bsp
...
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_adc.c
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_adc_ex.c
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_pcd.c
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_pcd_ex.c
...
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_uart.c
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_hal_uart_ex.c
BSP_DRIVERS_SRCS_C += Drivers/STM32U5xx_HAL_Driver/Src/stm32u5xx_ll_usb.c
...
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_adc_ex.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_adc.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_pcd_ex.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_pcd.h
...
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_uart_ex.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_hal_uart.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_ll_adc.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_ll_i2c.h
BSP_DRIVERS_SRCS_H += Drivers/STM32U5xx_HAL_Driver/Inc/stm32u5xx_ll_usb.h

BSP_SRCS_S += startup_stm32u575citxq.s
BSP_LD_PREFIX = STM32U575CITXQ_FLASH
#BSP_SRCS_S += startup_stm32u575xx.s
#BSP_LD_PREFIX = STM32U575xx_FLASH
...
CFLAGS += -DAWH575_MF1_V2 -DRELEASE_VERSION=\"$(shell ../../../../get_release_ver.sh)\"
...
# Add AsiaRF Library
include $(MMIOT_ROOT)/mk/arflib.mk
