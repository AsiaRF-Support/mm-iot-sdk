...
#define BUSY_IRQ_LINE       (LL_EXTI_LINE_0)
#define BUSY_IRQ_HANDLER    EXTI0_IRQHandler
...
/* Private defines -----------------------------------------------------------*/
#define BUSY_Pin LL_GPIO_PIN_0
#define BUSY_GPIO_Port GPIOA
#define BUSY_EXTI_IRQn EXTI0_IRQn
...
#define PWM_OUTPUT_Pin LL_GPIO_PIN_0
...
#define RL1_RST_Pin LL_GPIO_PIN_3
#define RL1_RST_GPIO_Port GPIOB
#define RL2_RST_Pin LL_GPIO_PIN_4
#define RL2_RST_GPIO_Port GPIOB
#define RL3_RST_Pin LL_GPIO_PIN_5
#define RL3_RST_GPIO_Port GPIOB
#define RL1_SET_Pin LL_GPIO_PIN_6
#define RL1_SET_GPIO_Port GPIOB
#define RL2_SET_Pin LL_GPIO_PIN_7
#define RL2_SET_GPIO_Port GPIOB
#define RL3_SET_Pin LL_GPIO_PIN_8
#define RL3_SET_GPIO_Port GPIOB
...
#define PLATFORM_NAME				PLATFORM_NAME_AWH575_001
