...
/* Private defines -----------------------------------------------------------*/
#define RS485_LED_Pin LL_GPIO_PIN_13
#define RS485_LED_GPIO_Port GPIOC
#define SPI_CS_Pin LL_GPIO_PIN_14
#define SPI_CS_GPIO_Port GPIOC
#define WAKE_Pin LL_GPIO_PIN_15
#define WAKE_GPIO_Port GPIOC
#define SPI2_CS_Pin LL_GPIO_PIN_0
#define SPI2_CS_GPIO_Port GPIOH
#define RESET_N_Pin LL_GPIO_PIN_1
#define RESET_N_GPIO_Port GPIOH
#define RS485_TX_Pin LL_GPIO_PIN_0
#define RS485_TX_GPIO_Port GPIOA
#define RS485_RX_Pin LL_GPIO_PIN_1
#define RS485_RX_GPIO_Port GPIOA
#define USER_TX_Pin LL_GPIO_PIN_2
#define USER_TX_GPIO_Port GPIOA
#define USER_RX_Pin LL_GPIO_PIN_3
#define USER_RX_GPIO_Port GPIOA
#define BUSY_Pin LL_GPIO_PIN_4
#define BUSY_GPIO_Port GPIOA
#define BUSY_EXTI_IRQn EXTI4_IRQn
#define RS232_RX_Pin LL_GPIO_PIN_5
#define RS232_RX_GPIO_Port GPIOA
#define En_Ain1_Pin LL_GPIO_PIN_6
#define En_Ain1_GPIO_Port GPIOA
#define RS232_TX_Pin LL_GPIO_PIN_7
...
#define RS232_LED_Pin LL_GPIO_PIN_13
#define RS232_LED_GPIO_Port GPIOB
...
#define SPI2_SCK_Pin LL_GPIO_PIN_9
...
#define PLATFORM_NAME				PLATFORM_NAME_AWH575_MF1_V2
#define PLATFORM_RS485_NUM			1
#define PLATFORM_RS232_NUM			1
